...
RESOURCES = \
	...
	$(CONTENTDIR)/BlinnPhongFragShader.cpp \
	$(CONTENTDIR)/BlinnPhongVertShader.cpp \
...
$(CONTENTDIR)/BlinnPhongVertShader.cpp: $(CONTENTDIR) ./BlinnPhongVertShader.vsh
	$(FILEWRAP)  -s  -o $@ ./BlinnPhongVertShader.vsh
	-$(FILEWRAP)  -oa $@ ./BlinnPhongVertShader.vsc

$(CONTENTDIR)/BlinnPhongFragShader.cpp: $(CONTENTDIR) ./BlinnPhongFragShader.fsh
	$(FILEWRAP)  -s  -o $@ ./BlinnPhongFragShader.fsh
	-$(FILEWRAP)  -oa $@ ./BlinnPhongFragShader.fsc
